...
[post 52](/posts/52-workflow-construct/) from the authorship
side: how a plugin is written, not which plugins to install.
This is the construct's editor-extensibility companion to
[post 30](/posts/30-setupRvimtex/) (which documents specific
R-plus-LaTeX plugins) and
[post 41](/posts/41-ultisnipspythonpost/) (which documents
UltiSnips snippet authorship). Together the three posts give
...
evaluated](media/images/ambiance2.png){.img-fluid height=3.5in}
...
1. Post 70: [Updating an R Package: A Complete Workflow](../70-rp-package-update-workflow/)
2. **Post 72: Writing a Simple Vim Plugin for REPL Interaction** (this post)
