...
- r
- r-packages
description: 'I did not really know how Vim''s terminal API worked until I wrote a
  small plugin that sends code from an editing buffer to a running R session.
...
evaluated](media/images/ambiance2.png){.img-fluid}
...
editor](media/images/ambiance3.png){.img-fluid}
